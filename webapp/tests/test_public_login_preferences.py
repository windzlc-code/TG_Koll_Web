...
class PublicLoginUiSourceTests(unittest.TestCase):
    ...
    def test_home_navigation_opens_console_or_existing_login_dialog(self):
        ...
        self.assertIn('<script async src="/assets/opc/site-navigation.js', page)
        self.assertIn('<script defer src="/assets/opc/site-navigation.js', pricing)
        for markup in (pricing,):
        ...
        self.assertNotIn('/assets/vendor/opencc-js/st-characters.js?v=1.4.1', page)
        self.assertIn('function schedulePublicLanguageDictionaries()', self.script)
