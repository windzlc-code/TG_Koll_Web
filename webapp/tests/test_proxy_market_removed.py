...
class ProxyMarketRemovalTests(unittest.TestCase):
    ...
    def test_account_proxy_picker_is_the_only_user_purchase_and_selection_surface(self):
        ...
        self.assertIn('>平台</button>', self.console_script)
        self.assertIn('>用户</button>', self.console_script)
        ...
        self.assertIn('.account-proxy-select-menu[open] .account-proxy-select-menu-options', self.console_styles)
