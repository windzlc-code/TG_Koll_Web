...
class ProxyMarketFrontendTests(unittest.TestCase):
    ...
    def test_admin_proxy_market_actions_are_split_and_labels_are_clear(self):
        ...
        self.assertIn("min-width: 288px", html)
        self.assertIn("min-width: 304px", html)
        self.assertIn("flex-wrap: nowrap", html)
        self.assertIn("height: 36px", html)
        self.assertIn("height: 44px", html)
        self.assertIn('id="proxyMarketRecordsTabs"', html)
        self.assertIn('id="proxyMarketInventoryTab"', html)
        self.assertIn('id="proxyMarketAllocationTab"', html)
        self.assertIn('id="proxyMarketInventoryPanel"', html)
        ...
        self.assertIn('republish.dataset.proxyMarketAction = "republish"', source)
        self.assertIn('<span>重新发布</span>', source)
        self.assertIn('async function republishProxyMarketRow(itemId, control', source)
        self.assertIn('/test-and-publish`', source)
