...
class ConsoleSessionBoundaryTests(unittest.TestCase):
    ...
    def test_account_proxy_selection_uses_a_shared_floating_modal_and_entry_card(self):
        ...
        self.assertIn('document.createElement("div")', picker_open)
        ...
        self.assertIn('modal.addEventListener("click"', picker_open)
        self.assertIn('modal.addEventListener("change"', picker_open)
        ...
        self.assertIn('returnModal.hidden = true', picker_open)
        self.assertIn('returnModal.hidden = false', picker_open)
    ...
    def test_account_proxy_modal_keeps_filter_interaction_stable_and_content_sized(self):
        ...
        self.assertIn('modal.addEventListener("input"', picker)
        self.assertIn('modal.addEventListener("change"', picker)
