...
class ConsoleSessionBoundaryTests(unittest.TestCase):
    ...
    def test_account_proxy_selection_uses_a_shared_floating_modal_and_entry_card(self):
        ...
        self.assertIn('poolData?.monthly_free?.available !== false', picker_entry_copy)
        self.assertIn('monthlyFree ? "免费选择" : "选择代理"', picker_entry_copy)
        ...
        self.assertIn('accountProxyPoolFiltersHtml("modal"', picker_open)
        self.assertIn('accountProxyOptionCardsHtml(selectedProxyId, { scope: "modal" })', picker_open)
