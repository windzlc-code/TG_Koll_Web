...
class ConsoleSessionBoundaryTests(unittest.TestCase):
    ...
    def test_account_and_browser_status_refresh_while_publish_is_running(self):
        ...
        self.assertIn("function publishAssistanceTrackedTask", self.source)
        self.assertIn("isPublishAssistanceOpen()", self._function_source("shouldShowPublishAssistanceRestore"))
        self.assertIn("publishAssistanceTrackedTask(", self._function_source("shouldShowPublishAssistanceRestore"))
        self.assertIn("publishAssistanceRestoreTaskId", self._function_source("publishAssistanceTrackedTask"))
        ...
        self.assertIn('data-login-assistance-stop-close', self._function_source("renderLoginAssistanceAction"))
    ...
    def test_account_create_uses_the_full_editor_instead_of_the_legacy_form(self):
        ...
        self.assertIn("openAccountPoolEditorModal({ ...options, platform })", create_entry)
        self.assertNotIn("官方授权", create_entry)
        self.assertNotIn("/oauth/start", create_entry)
