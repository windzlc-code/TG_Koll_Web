...
class ConsoleSessionBoundaryTests(unittest.TestCase):
    ...
    def test_mobile_live_browser_placeholders_and_expanded_window_prioritizes_media(self):
        ...
        self.assertIn("inset: 6px;", landscape_card)
        self.assertIn("width: auto;", landscape_card)
        self.assertIn("height: auto;", landscape_card)
        self.assertIn("transform: none;", landscape_card)
        ...
        self.assertIn("width: 100dvh;", landscape_media)
        self.assertIn("height: 100dvw;", landscape_media)
    ...
    def test_expanded_mobile_browser_uses_one_compact_translucent_summary(self):
        ...
        self.assertIn("top: auto;", mobile_summary)
        self.assertIn("left: auto;", mobile_summary)
