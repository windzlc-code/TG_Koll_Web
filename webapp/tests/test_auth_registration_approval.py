...
class RegistrationApprovalTests(unittest.TestCase):
    ...
    def test_admin_entry_and_page_are_server_side_role_protected(self):
        ...
        self.assertIn("Telegram", rendered_admin.text)
        self.assertEqual(admin.get("/api/admin/tg_settings").status_code, 200)
        self.assertEqual(admin.get("/api/admin/tg_tweet/settings").status_code, 200)
        self.assertEqual(anonymous.get("/api/admin/tg_tweet/settings").status_code, 401)
