...
class ConsolePublishHistoryHotDataTests(unittest.TestCase):
    ...
    def test_publish_history_renders_full_hot_metrics_and_manual_refresh(self):
        ...
        self.assertIn("data-publish-history-recognize", toolbar_edit)
        self.assertIn("data-publish-history-delete-selected", toolbar_edit)
        self.assertIn("自动识别", toolbar_edit)
        self.assertNotIn("手动识别", toolbar_edit)
        self.assertIn("renderMoreIcon()", toolbar_edit)
        self.assertIn("persona-history-filter-icon", toolbar_edit)
        self.assertIn("renderFormListIcon()", toolbar_edit)
    ...
    def test_manual_hot_refresh_uses_authenticated_source_and_reloads_history(self):
        ...
        self.assertIn("backfillHistory", refresh)
        self.assertIn("auto: true", refresh)
        recognize = function_source("recognizePublishHistoryRecord", "deletePublishHistoryRecords")
        self.assertIn("backfillHistory: true", recognize)
        self.assertNotIn("手动识别已发布推文", recognize)
