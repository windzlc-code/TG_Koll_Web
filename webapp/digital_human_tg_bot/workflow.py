...
DIGITAL_HUMAN_VIDEO_WORKFLOW_ID = "2068273204367544322"
...
class DigitalHumanWorkflowRunner:
    ...
    def _create_digital_human_video(
        ...
        *,
        ...
        workflow_id = create_video.normalize_digital_human_video_app_id(self.config.video_workflow_id)
        node_info_list = create_video._build_node_info_list(
            app_id=workflow_id,
            image_url=uploaded_image.filename,
            audio_url=uploaded_audio.filename,
