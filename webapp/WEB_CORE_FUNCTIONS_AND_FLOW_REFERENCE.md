...
- `persona-dashboard.js`: 人设看板壳层, 是单独页面, 不是控制台右侧详情区
...
- 它不是控制台右侧详情面板的一部分
- 控制台里如果出现“打开人设看板”按钮, 应该是打开独立页面, 不是把当前控制台内容跳成看板
