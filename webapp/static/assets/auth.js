...
const AUTH_COPY = {
  "zh-Hans": {
    ...
    stageCopy: "管理员生成的临时密码只用于首次验证。完成修改后，账号才会进入推文工作台。",
    ...
    cardCopy: "完成后将直接进入推文工作台", verificationEmailPrefix: "验证码将发送到已验证邮箱：",
    sendCode: "发送邮箱验证码", emailCode: "邮箱验证码", confirmPassword: "确认新密码",
    saveAndContinue: "保存并进入推文工作台", backToLogin: "返回用户登录", retryCode: "重新发送验证码",
  ...
  "zh-Hant": {
    ...
    stageCopy: "管理員產生的臨時密碼只用於首次驗證。完成修改後，帳號才會進入推文工作台。",
    ...
    cardCopy: "完成後將直接進入推文工作台", verificationEmailPrefix: "驗證碼將傳送到已驗證電子郵件：",
    sendCode: "傳送電子郵件驗證碼", emailCode: "電子郵件驗證碼", confirmPassword: "確認新密碼",
    saveAndContinue: "儲存並進入推文工作台", backToLogin: "返回使用者登入", retryCode: "重新傳送驗證碼",
