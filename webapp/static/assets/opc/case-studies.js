(() => {
  ...
  const sourceCases = [
    ...
    },
    {
      ...
      samplePosts: 15,
      engagement: 2000,
      averageEngagement: 133.3,
      viewsPerFollower: 0.59,
      engagementPerThousandViews: 524.1,
      persona: "生活观察内容账号",
  ...
  // Reuse the standard site exit icon used by the account control instead of a generic close mark.
  const closeIcon = () => '<svg class="case-action-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M10 5H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h4M14 8l4 4-4 4M18 12H9"></path></svg>';
