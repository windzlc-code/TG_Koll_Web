(() => {
  ...
  // Keep the report dialog aligned with the shared public modal close icon.
  const closeIcon = () => '<svg class="case-action-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="m6 6 12 12"></path><path d="m18 6-12 12"></path></svg>';
