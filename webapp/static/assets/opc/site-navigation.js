      ...
      <div id="siteAccountPopover" class="site-account-popover" data-site-account-popover hidden role="dialog" aria-label="个人信息">
        ...
        <section class="site-account-billing" data-site-account-billing aria-labelledby="siteAccountBillingTitle">
          ...
          <div class="site-account-billing-grid" aria-live="polite">
            ...
            <div class="site-account-billing-card site-account-publish-cooldown"><span class="site-account-billing-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="8.5"/><path d="M12 7v5l3.5 2M7 3.5 5 5.5M17 3.5l2 2"/></svg></span><span class="site-account-billing-copy"><span>发布间隔</span><strong data-site-publish-cooldown>30 分钟</strong><small data-site-publish-cooldown-note>按执行账号计算</small></span></div>
          </div>
