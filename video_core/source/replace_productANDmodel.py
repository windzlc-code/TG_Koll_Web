...
def _submit_task(*, api_key: str, app_id: str, node_info_list: list[dict[str, Any]], instance_type: str | None = None) -> dict[str, Any]:
    ...
    payload = {
        ...
        "instanceType": runninghub_common.instance_type_for_workflow(app_id, instance_type),
            ...
            for seg_index, seg in enumerate(segments, start=1):
                ...
                for step_index, app_id in enumerate(model_chain_ids, start=1):
                    ...
                    model_node_info = replace_model._build_node_info_list(
                        mode=replace_model.MODE_ORIGINAL,
                        app_id=app_id,
                    ...
                    model_submit = _submit_task(api_key=cfg.rh_api_key, app_id=app_id, node_info_list=model_node_info, instance_type=cfg.instance_type)
                ...
                for step_index, app_id in enumerate(product_chain_ids, start=1):
                    ...
                    if cfg.product_mapping:
                        ...
                        product_submit = _submit_task(api_key=cfg.rh_api_key, app_id=app_id, node_info_list=product_node_info, instance_type=cfg.instance_type)
                        ...
                        product_done = replace_product.requests_api(
                            ...
                            api_key=cfg.rh_api_key,
                            app_id=app_id,
                            instance_type=runninghub_common.instance_type_for_workflow(app_id, cfg.instance_type),
                            logger=print,
                        )
                        product_step_record["done"] = product_done
                        if str(product_done.get("status")) != "success":
