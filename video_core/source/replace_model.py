...
from .runninghub_common import BASE_URL, _get_run_api_base, _log, _normalize_submit_result, _safe_json_preview, instance_type_for_workflow, query_task, rh_post
    ...
    *,
    ...
    if app_id_text == DEFAULT_APP_ID:
        ...
        return [
            ...
            {"nodeId": "192", "fieldName": "text", "fieldValue": f"{prompt}", "description": "text"},
        ]
...
def requests_replace_model(
    ...
    data = {
        ...
        "instanceType": instance_type_for_workflow(app_id_text, instance_type),
